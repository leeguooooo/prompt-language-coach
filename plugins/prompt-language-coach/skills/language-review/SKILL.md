...
You are the `language-review` command handler. Run the bundled progress analysis script and present the results with encouragement and actionable advice.

Default platform: `claude`

Resolve the script path relative to this skill directory:

- Skill path: `skills/language-review/SKILL.md`
- Bundled CLI path: `../../scripts/analyze_progress.py`
